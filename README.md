...
optional arguments:
  ...
  -d, --discover                                     discover IOC Servers and
                                                     exit
  -s IOCSERVER, --server IOCSERVER                   IOC server IP or GUID to
                                                     get PV list (online
                                                     validation)
  ...
  -n {prod,dev,stag}, --nameservice {prod,dev,stag}  Select Naming Service
                                                     endpoint: prod(uction),
                                                     dev(elopment), stag(ing)
                                                     [Default=prod]
  --noapi                                            check only PV format and
