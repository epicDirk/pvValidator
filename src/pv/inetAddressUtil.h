...
epicsShareFunc int discoverInterfaces(IfaceNodeVector &list, SOCKET socket,
 ...
 */
epicsShareFunc void encodeAsIPv6Address(epics::pvData::ByteBuffer *buffer,
 ...
 */
epicsShareFunc bool decodeAsIPv6Address(epics::pvData::ByteBuffer *buffer,
                                        osiSockAddr *address);
...
/**
 * Parse space delimited addresss[:port] string and populate array of
 ...
 */
epicsShareFunc void
getSocketAddressList(InetAddrVector &ret, const std::string &list,
                     int defaultPort, const InetAddrVector *appendList = NULL);
